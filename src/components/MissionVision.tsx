        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-center py-2">
          ...
          <div className="md:col-span-7 space-y-5 text-center md:text-left">
            ...
            <p className="text-slate-600 text-base sm:text-lg leading-relaxed font-normal italic">
              "At Little's Heaven, we provide a safe, caring, and joyful environment where every child can learn, grow, and thrive. Through play-based learning and personal attention, we help children build confidence, creativity, and a love for learning."
            </p>
            <div className="pt-2 border-t border-slate-100/80">
              <div className="text-xl font-extrabold text-slate-900">Jeeja Azhayil</div>
